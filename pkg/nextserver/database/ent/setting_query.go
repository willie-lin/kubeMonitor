...
func (sq *SettingQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (sq *SettingQuery) FirstIDX(ctx context.Context) uint {
...
func (sq *SettingQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (sq *SettingQuery) OnlyIDX(ctx context.Context) uint {
...
func (sq *SettingQuery) IDs(ctx context.Context) ([]uint, error) {
	var ids []uint
...
func (sq *SettingQuery) IDsX(ctx context.Context) []uint {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
