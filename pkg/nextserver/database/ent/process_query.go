...
func (pq *ProcessQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (pq *ProcessQuery) FirstIDX(ctx context.Context) uint {
...
func (pq *ProcessQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (pq *ProcessQuery) OnlyIDX(ctx context.Context) uint {
...
func (pq *ProcessQuery) IDs(ctx context.Context) ([]uint, error) {
	var ids []uint
...
func (pq *ProcessQuery) IDsX(ctx context.Context) []uint {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
