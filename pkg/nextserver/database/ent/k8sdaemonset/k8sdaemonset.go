...
const (
	// Label holds the string label denoting the k8sdaemonset type in the database.
	Label = "k8s_daemon_set"
	...
	// Table holds the table name of the k8sdaemonset in the database.
	Table = "k8sDaemonSets"
)

// Columns holds all SQL columns for k8sdaemonset fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
