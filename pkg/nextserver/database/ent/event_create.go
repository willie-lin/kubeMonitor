...
func (ec *EventCreate) SetTs(t time.Time) *EventCreate {
	ec.mutation.SetTs(t)
	return ec
}

// SetValue sets the "value" field.
func (ec *EventCreate) SetValue(f float64) *EventCreate {
	ec.mutation.SetValue(f)
	return ec
}

// SetAcked sets the "acked" field.
func (ec *EventCreate) SetAcked(b bool) *EventCreate {
	ec.mutation.SetAcked(b)
	return ec
}

// SetAckedTs sets the "ackedTs" field.
func (ec *EventCreate) SetAckedTs(t time.Time) *EventCreate {
	ec.mutation.SetAckedTs(t)
	return ec
}

// SetEndpointId sets the "endpointId" field.
func (ec *EventCreate) SetEndpointId(u uint) *EventCreate {
	ec.mutation.SetEndpointId(u)
	return ec
}

// SetTypeId sets the "typeId" field.
func (ec *EventCreate) SetTypeId(u uint) *EventCreate {
	ec.mutation.SetTypeId(u)
	return ec
}

// SetNameId sets the "nameId" field.
func (ec *EventCreate) SetNameId(u uint) *EventCreate {
	ec.mutation.SetNameId(u)
	return ec
}

// SetLabelId sets the "labelId" field.
func (ec *EventCreate) SetLabelId(u uint) *EventCreate {
	ec.mutation.SetLabelId(u)
	return ec
}

// SetClusterId sets the "clusterId" field.
func (ec *EventCreate) SetClusterId(u uint) *EventCreate {
	ec.mutation.SetClusterId(u)
	return ec
}

// SetAgentId sets the "agentId" field.
func (ec *EventCreate) SetAgentId(u uint) *EventCreate {
	ec.mutation.SetAgentId(u)
	return ec
}

// SetNodeId sets the "nodeId" field.
func (ec *EventCreate) SetNodeId(u uint) *EventCreate {
	ec.mutation.SetNodeId(u)
	return ec
}

// SetProcesId sets the "procesId" field.
func (ec *EventCreate) SetProcesId(u uint) *EventCreate {
	ec.mutation.SetProcesId(u)
	return ec
}

// SetContainerId sets the "containerId" field.
func (ec *EventCreate) SetContainerId(u uint) *EventCreate {
	ec.mutation.SetContainerId(u)
	return ec
}
...
func (ec *EventCreate) check() error {
	...
	if _, ok := ec.mutation.Ts(); !ok {
		return &ValidationError{Name: "ts", err: errors.New(`ent: missing required field "ts"`)}
	}
	if _, ok := ec.mutation.Value(); !ok {
		return &ValidationError{Name: "value", err: errors.New(`ent: missing required field "value"`)}
	}
	if _, ok := ec.mutation.Acked(); !ok {
		return &ValidationError{Name: "acked", err: errors.New(`ent: missing required field "acked"`)}
	}
	if _, ok := ec.mutation.AckedTs(); !ok {
		return &ValidationError{Name: "ackedTs", err: errors.New(`ent: missing required field "ackedTs"`)}
	}
	if _, ok := ec.mutation.EndpointId(); !ok {
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Acked(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
	...
	if value, ok := ec.mutation.AckedTs(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
	...
	if value, ok := ec.mutation.EndpointId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.TypeId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.NameId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.LabelId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.AgentId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.NodeId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.ProcesId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.ContainerId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
	...
	if value, ok := ec.mutation.PodId(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
