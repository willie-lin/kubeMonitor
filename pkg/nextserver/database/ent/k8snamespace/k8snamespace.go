...
const (
	// Label holds the string label denoting the k8snamespace type in the database.
	Label = "k8s_namespace"
	...
	// Table holds the table name of the k8snamespace in the database.
	Table = "k8sNamespaces"
)

// Columns holds all SQL columns for k8snamespace fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
