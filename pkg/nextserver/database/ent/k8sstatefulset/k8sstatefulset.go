...
const (
	// Label holds the string label denoting the k8sstatefulset type in the database.
	Label = "k8s_stateful_set"
	...
	// Table holds the table name of the k8sstatefulset in the database.
	Table = "k8sStatefulSets"
)

// Columns holds all SQL columns for k8sstatefulset fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
