...
const (
	// Label holds the string label denoting the k8sdeployment type in the database.
	...
	// Table holds the table name of the k8sdeployment in the database.
	Table = "k8sDeployments"
)

// Columns holds all SQL columns for k8sdeployment fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
