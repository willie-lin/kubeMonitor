...
const (
	// Label holds the string label denoting the k8snode type in the database.
	Label = "k8s_node"
	...
	// Table holds the table name of the k8snode in the database.
	Table = "k8sNodes"
)

// Columns holds all SQL columns for k8snode fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
